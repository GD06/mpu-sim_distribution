...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Run the simulation for matrix transposition",
    ...
    total_cycles, sim_freq = hardware.run_simulation(
        kernel=opt_kernel, 
        kernel_args=[ptr_input, ptr_output, args.num_rows, args.num_cols],
    ...
    ground_truth = _py_transpose(input_matrix, args.num_rows, args.num_cols)
