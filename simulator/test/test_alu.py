...
class FakeSubCore():
    ...
    def _append_trace_event_dur(self, tid, name, ts, dur, cat="", args={}):
        # NOTE this is a dummy function for testing only
        pass
    ...
    def _commit(self):
        while True:
            ...
            for i in range(len(instr.dst_operands)):
                ...
                self.dep_table_exe.entry[entry_id].decrease_write(dst_op.op_str)
    ...
    def test_add_f32_pred(self):
        ...
        for each_op in src_ops:
            ...
            self.subcore.reg_track_table\
                .entry[self.subcore.warp_id].write_update(
        ...
        self.opc_fb_alu.instr_entry_queue.put(instr_entry)
